...
Seja bem vindo <b><?php echo $_SESSION['usuario'];?>  </b><a href="deslogar.php">[Sair]</a><br/> </b><a style="position:relative; top:-20px; left:85%;" href="editarSenha.php">[Alterar Senha]</a><br/>
        ...
        <br />
        <h5>Instituto Federal do Cear&aacute; - Campus Tiangu&aacute; Vers�o 1.2</h5>
    </body>
</html><?php  
