...
<div style="position: relative; width: 180px; height: 200px; left: 535px;">
	<form action="login.php" method="POST"  id="validaFormulario">
	 ...
	 <h5>Instituto Federal do Cear&aacute; - Campus Tiangu&aacute; - Vers&atilde;o 1.02</h5>
<?php	 
...
// 							}
						...
						$mensagem = 'Senha incorreta!Tente novamente ou entre em contato com a TI.';
						retornar($mensagem, 'login.php');
					}
				}else {
				$mensagem = 'Usu&aacute;rio n&atilde;o encontrado! Tente novamente ou entre em contato com a TI.';
                            retornar($mensagem, 'login.php');		
			      }
		}else{
